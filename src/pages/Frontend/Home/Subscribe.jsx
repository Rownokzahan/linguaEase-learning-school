...
const Subscribe = () => {
  return (
    <Container>
      <div className="grid lg:grid-cols-2 gap-8 lg:gap-20 py-16 mt-28 bg-accent_2">
        ...
        <form action="" className="relative lg:w-[70%]">
          <input
            type="email"
            className="bg-accent_2 border px-6 py-2 w-full rounded-full text-white focus:outline outline-white placeholder:text-white"
